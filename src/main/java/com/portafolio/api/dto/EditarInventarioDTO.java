...
public class EditarInventarioDTO {
    ...
    public EditarInventarioDTO(Integer id, String nombre, Date fecha_inicio, String descripcion, Integer usuario_id, Integer estado_inventario_id) {
        this.id = id;
        this.nombre = nombre;
